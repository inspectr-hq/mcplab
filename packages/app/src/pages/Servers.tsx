      ...
      {servers.length === 0 ? (
        <div className="flex flex-col items-center justify-center rounded-lg border border-dashed py-16 text-center">
          ...
          <Button
            ...
            size="sm"
            className="mt-4"
            onClick={() => navigate('/libraries/servers/new')}
          >
            <Plus className="mr-2 h-4 w-4" />
            Add Server
          </Button>
                    ...
                    <TableCell className="text-right" onClick={(e) => e.stopPropagation()}>
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <Button
                          ...
                          variant="outline"
                          onClick={() =>
                            navigate(`/libraries/servers/${encodeURIComponent(server.id)}`)
                          }
                        >
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              <span className="font-mono">{pendingDelete ? displayName(pendingDelete) : ''}</span>{' '}
