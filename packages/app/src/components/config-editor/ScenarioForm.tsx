                  ...
                  <div className="flex items-start justify-between gap-2">
                    <div className="min-w-0">
                      ...
                      <p className="mt-1 text-xs text-muted-foreground">
                        ...
                        values from the final answer for reporting, snapshots, and comparisons.
                      </p>
                    </div>
                    {!readOnly && (
                      <Button
                ...
                <CardContent className="space-y-2 text-xs text-muted-foreground">
                  ...
                  <p>
                    ...
                    <span className="font-mono">
                      {scenario.snapshotEval?.baselineSnapshotId ||
                        snapshotEval?.baselineSnapshotId ||
                        'Not configured'}
                    </span>
                  </p>
                  <p>
                    Policy: <span className="font-mono">{snapshotEval?.mode ?? 'warn'}</span> ·
                    config-level switch{' '}
