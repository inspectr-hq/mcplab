...
export const workspaceSource: EvalDataSource = {
  ...
  async stopRoverScenario(jobId, scenarioId) {
    return workspaceApiClient.stopRoverScenario(jobId, scenarioId);
  },
  ...
  subscribeRunQueue(onEvent) {
    return workspaceApiClient.subscribeRunQueue(onEvent);
  },
