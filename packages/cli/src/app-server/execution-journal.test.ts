...
import { appendExecutionEvent, readExecutionEvents, readLatestResultSnapshot, writeAtomicText } from './execution-journal.js';
...
describe('execution journal', () => {
  it('appends and replays valid events while ignoring a truncated final line', () => {
    ...
    try {
      ...
      expect(readLatestResultSnapshot(dir)).toBeNull();
    } finally {
